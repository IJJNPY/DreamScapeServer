<template>
	<view class="picGroup">
		<view :style="{width:width+'px',aspectRatio:ratio}" class="box add" v-if="!formData.tempurl" @click="selectPicurl">
		...
		<cropper-image ref="cropperRef" :maxImgSize="maxImgSize" :tempurl="formData.tempurl"
