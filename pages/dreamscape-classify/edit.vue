<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="picurl" label="分类封面">
      ...
      <uni-forms-item name="select" label="状态">
...
<script>
  import { validator } from '../../js_sdk/validator/dreamscape-classify.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'dreamscape-classify';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("sort,picurl,name,select,createTime,updateTime").get().then((res) => {
