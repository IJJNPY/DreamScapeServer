...
// E:/UniappCode/DreamScapeServer/node_modules/vue-cropper/dist/vue-cropper.es.js
...
function U(t, e, i, s, r, o) {
  return y(), x("div", {
    ...
    H(w("div", {
      ...
      }, X(t.cropInfo.width) + " × " + X(t.cropInfo.height), 5)) : O("", true),
      t.fixedBox ? O("", true) : (y(), x("span", D, [
        w("span", {
